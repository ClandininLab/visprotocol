...
@author: minseungchoi
Shamelessly taken from mhturner and michellepang
"""
import numpy as np
import os
import inspect
...
class UniformFlash(BaseProtocol):
    """
    Slightly modified mhturner's UniformFlash to allow for multiple intensity / contrast values. Basically the same as michellepang's MultipleContrastFlash
    """
    def __init__(self):
        super().__init__()
...
class MovingSquareMapping(BaseProtocol):
    ...
    def getEpochParameters(self):
        ...
        self.convenience_parameters['angle'] = angle
        self.convenience_parameters['center'] = center
