...
def main():
    ...
    bruker_left_screen = Screen(width=w, height=h, rotation=pi-pi/4, offset=(4.0e-2, 3.9e-2, -6.1e-2), server_number=1, id=2, fullscreen=True, vsync=True, square_size=(0.2, 0.2), square_loc=(0.80, -1.0))

    aux_screen = Screen(width=w, height=h, rotation=pi-pi/4, offset=(4.0e-2, 3.9e-2, -6.1e-2), server_number=1, id=0, fullscreen=False, vsync=True, square_size=(0.0, 0.0))
