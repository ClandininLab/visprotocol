...
def main():
    ...
    bruker_left_screen = Screen(width=w, height=h, rotation=pi-pi/4, offset=(4.0e-2, 3.9e-2, -6.1e-2), id=1, fullscreen=True, vsync=True, square_size=(0.2, 0.2), square_loc=(0.8, -1.0))
