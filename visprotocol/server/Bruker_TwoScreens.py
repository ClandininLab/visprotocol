...
def main():
    ...
    bruker_right_screen = Screen(width=w, height=h, rotation=pi-pi/4, offset=(5.0e-2, 6.1e-2, -6.1e-2), id=2, fullscreen=True, vsync=None, square_side=3e-2, square_loc='ll')
